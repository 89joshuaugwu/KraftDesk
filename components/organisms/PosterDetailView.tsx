  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6">
      ...
      {isOwner && poster.status === "changes_requested" && (
        <label className="mt-4 flex min-h-[48px] cursor-pointer items-center justify-center gap-2 rounded-lg border-2 border-dashed border-kraft-tan bg-warm-white text-sm font-medium text-kraft-brown hover:border-terracotta">
